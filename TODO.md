# Configuração do ChatBot no Servidor - Progresso
...
- [ ] 6. Deploy em servidor VPS/Cloud (comandos prontos)
- [ ] 7. Configurar reverse proxy (nginx) + SSL (se VPS)
- [ ] 8. Habilitar backups automáticos (Drive/Notion)
