...
def responder_com_contexto(intencao, respostas, msg, contexto):
    ...
    if intencao == "como_esta" and contexto.get("ultima_intencao") == "emocao_usuario":
        return random.choice(
            [
                f"Estou bem, {nome_usuario}. E quero continuar aqui com você. Se quiser, me conta mais do que está sentindo." if nome_usuario else "Estou bem, e quero continuar aqui com você. Se quiser, me conta mais do que está sentindo.",
                f"Estou bem por aqui, {nome_usuario}. E eu posso continuar te ouvindo, se você quiser falar mais." if nome_usuario else "Estou bem por aqui. E eu posso continuar te ouvindo, se você quiser falar mais.",
                f"Estou bem, sim, {nome_usuario}. E sigo com você nessa conversa." if nome_usuario else "Estou bem, sim. E sigo com você nessa conversa.",
            ]
        )
    ...
    if intencao == "idioma":
        ...
        return random.choice(
            [
                f"Consigo conversar em português, inglês e espanhol em perguntas e interações mais comuns, {nome_usuario}." if nome_usuario else "Consigo conversar em português, inglês e espanhol em perguntas e interações mais comuns.",
    ...
    if intencao == "emocao_usuario":
        ...
        if any(p in texto for p in ("triste", "sad")):
            return random.choice(
                [
                    f"Sinto muito que você esteja assim, {nome_usuario}. Se quiser, pode me contar o que aconteceu e eu fico com você nessa conversa." if nome_usuario else "Sinto muito que você esteja assim. Se quiser, pode me contar o que aconteceu e eu fico com você nessa conversa.",
        ...
        if any(p in texto for p in ("feliz", "happy")):
            return random.choice(
                [
                    f"Que bom ouvir isso, {nome_usuario}. Gosto quando a conversa chega com essa energia boa." if nome_usuario else "Que bom ouvir isso. Gosto quando a conversa chega com essa energia boa.",
        ...
        if any(p in texto for p in ("cansad", "tired")):
            return random.choice(
                [
                    f"Imagino, {nome_usuario}. Quando quiser, a gente pode manter a conversa mais leve e tranquila." if nome_usuario else "Imagino. Quando quiser, a gente pode manter a conversa mais leve e tranquila.",
...
def responder(msg, respostas_txt=ARQUIVO_MODOS, modo="normal", arquivo_aprendizado=ARQUIVO_APRENDIZADO, contexto=None):
    ...
    resposta = resposta.replace("{usuario}", nome_usuario or "")
